...
final alunos = <AlunoAcademia>[
  AlunoAcademia(id: 'a1', nome: 'Mariana Costa',    email: 'mariana@email.com', telefone: '(11) 99999-0001', plano: PlanoTipo.mensal,     vencimento: _d(12),  ativo: true,  ultimoCheckin: _d(-1)),
  AlunoAcademia(id: 'a2', nome: 'Carlos Mendes',    email: 'carlos@email.com',  telefone: '(11) 99999-0002', plano: PlanoTipo.trimestral, vencimento: _d(45),  ativo: true,  ultimoCheckin: _d(0)),
  AlunoAcademia(id: 'a3', nome: 'Fernanda Lima',    email: 'fernanda@email.com',telefone: '(11) 99999-0003', plano: PlanoTipo.mensal,     vencimento: _d(-8),  ativo: true,  ultimoCheckin: _d(-10)),
  AlunoAcademia(id: 'a4', nome: 'Rafael Santos',    email: 'rafael@email.com',  telefone: '(11) 99999-0004', plano: PlanoTipo.anual,      vencimento: _d(180), ativo: true,  ultimoCheckin: _d(0)),
  AlunoAcademia(id: 'a5', nome: 'Ana Paula Ribeiro',email: 'ana@email.com',     telefone: '(11) 99999-0005', plano: PlanoTipo.mensal,     vencimento: _d(3),   ativo: true,  ultimoCheckin: _d(-2)),
  AlunoAcademia(id: 'a6', nome: 'Bruno Alves',      email: 'bruno@email.com',   telefone: '(11) 99999-0006', plano: PlanoTipo.semestral,  vencimento: _d(60),  ativo: true,  ultimoCheckin: _d(0)),
  AlunoAcademia(id: 'a7', nome: 'Juliana Neves',    email: 'juliana@email.com', telefone: '(11) 99999-0007', plano: PlanoTipo.mensal,     vencimento: _d(-15), ativo: false, ultimoCheckin: _d(-20)),
  AlunoAcademia(id: 'a8', nome: 'Diego Oliveira',   email: 'diego@email.com',   telefone: '(11) 99999-0008', plano: PlanoTipo.trimestral, vencimento: _d(4),   ativo: true,  ultimoCheckin: _d(-3)),
  AlunoAcademia(id: 'a9', nome: 'Camila Torres',    email: 'camila@email.com',  telefone: '(11) 99999-0009', plano: PlanoTipo.mensal,     vencimento: _d(20),  ativo: true,  ultimoCheckin: _d(0)),
  AlunoAcademia(id:'a10', nome: 'Thiago Martins',   email: 'thiago@email.com',  telefone: '(11) 99999-0010', plano: PlanoTipo.anual,      vencimento: _d(90),  ativo: true,  ultimoCheckin: _d(-1)),
];
