...
class MockDatabase {
  ...
  final List<Exercicio> exercicios = [
    ...
    const Exercicio(id: 'e3',  nome: 'Supino declinado',                  grupoMuscular: 'Peito',   equipamento: 'Barra'),
    const Exercicio(id: 'e4',  nome: 'Crucifixo',                         grupoMuscular: 'Peito',   equipamento: 'Halteres'),
    const Exercicio(id: 'e31', nome: 'Crucifixo invertido',               grupoMuscular: 'Peito',   equipamento: 'Peck Deck'),
    const Exercicio(id: 'e32', nome: 'Crossover',                         grupoMuscular: 'Peito',   equipamento: 'Polia'),
    const Exercicio(id: 'e33', nome: 'Supino reto — máquina',             grupoMuscular: 'Peito',   equipamento: 'Máquina'),
    const Exercicio(id: 'e34', nome: 'Supino inclinado — máquina',        grupoMuscular: 'Peito',   equipamento: 'Máquina'),
    const Exercicio(id: 'e35', nome: 'Flexão de braço',                   grupoMuscular: 'Peito',   equipamento: 'Peso corporal'),
    // ── Costas ─────────────────────────────────────────────────────────────
    const Exercicio(id: 'e5',  nome: 'Puxada aberta pronada',             grupoMuscular: 'Costas',  equipamento: 'Polia'),
    const Exercicio(id: 'e6',  nome: 'Remada curvada — barra',            grupoMuscular: 'Costas',  equipamento: 'Barra'),
    const Exercicio(id: 'e7',  nome: 'Remada baixa — barra romana neutra',grupoMuscular: 'Costas',  equipamento: 'Polia'),
    const Exercicio(id: 'e8',  nome: 'Barra fixa',                        grupoMuscular: 'Costas',  equipamento: 'Peso corporal'),
    const Exercicio(id: 'e36', nome: 'Remada cavalinho — máquina neutra', grupoMuscular: 'Costas',  equipamento: 'Máquina'),
    const Exercicio(id: 'e37', nome: 'Remada serrote — halter',           grupoMuscular: 'Costas',  equipamento: 'Halteres'),
    const Exercicio(id: 'e38', nome: 'Puxada fechada supinada',           grupoMuscular: 'Costas',  equipamento: 'Polia'),
    const Exercicio(id: 'e39', nome: 'Remada unilateral — cabo',          grupoMuscular: 'Costas',  equipamento: 'Polia'),
    const Exercicio(id: 'e40', nome: 'Levantamento terra',                grupoMuscular: 'Costas',  equipamento: 'Barra'),
    // ── Pernas ─────────────────────────────────────────────────────────────
    ...
    const Exercicio(id: 'e13', nome: 'Stiff — barra',                     grupoMuscular: 'Pernas',  equipamento: 'Barra'),
    const Exercicio(id: 'e14', nome: 'Panturrilha em pé — máquina',       grupoMuscular: 'Pernas',  equipamento: 'Máquina'),
    const Exercicio(id: 'e15', nome: 'Afundo reverso',                    grupoMuscular: 'Pernas',  equipamento: 'Peso corporal'),
    const Exercicio(id: 'e41', nome: 'Agachamento guiado — Smith',        grupoMuscular: 'Pernas',  equipamento: 'Smith'),
    const Exercicio(id: 'e42', nome: 'Abdutor — cadeira articulada',      grupoMuscular: 'Pernas',  equipamento: 'Máquina'),
    const Exercicio(id: 'e43', nome: 'Cadeira flexora',                   grupoMuscular: 'Pernas',  equipamento: 'Máquina'),
    const Exercicio(id: 'e44', nome: 'Stiff — halteres',                  grupoMuscular: 'Pernas',  equipamento: 'Halteres'),
    const Exercicio(id: 'e45', nome: 'Panturrilha sentado — máquina',     grupoMuscular: 'Pernas',  equipamento: 'Máquina'),
    const Exercicio(id: 'e46', nome: 'Afundo caminhando',                 grupoMuscular: 'Pernas',  equipamento: 'Halteres'),
    const Exercicio(id: 'e47', nome: 'Agachamento sumô',                  grupoMuscular: 'Pernas',  equipamento: 'Halteres'),
    const Exercicio(id: 'e48', nome: 'Flexora — mesa articulada',         grupoMuscular: 'Pernas',  equipamento: 'Máquina'),
    // ── Ombros ─────────────────────────────────────────────────────────────
    const Exercicio(id: 'e16', nome: 'Desenvolvimento militar — barra',   grupoMuscular: 'Ombros',  equipamento: 'Barra'),
    const Exercicio(id: 'e17', nome: 'Elevação lateral — halteres',       grupoMuscular: 'Ombros',  equipamento: 'Halteres'),
    const Exercicio(id: 'e18', nome: 'Elevação frontal — halteres',       grupoMuscular: 'Ombros',  equipamento: 'Halteres'),
    const Exercicio(id: 'e19', nome: 'Encolhimento',                      grupoMuscular: 'Ombros',  equipamento: 'Halteres'),
    const Exercicio(id: 'e49', nome: 'Desenvolvimento — máquina',         grupoMuscular: 'Ombros',  equipamento: 'Máquina'),
    const Exercicio(id: 'e50', nome: 'Elevação frontal — corda polia',    grupoMuscular: 'Ombros',  equipamento: 'Polia'),
    const Exercicio(id: 'e51', nome: 'Abdução de ombros',                 grupoMuscular: 'Ombros',  equipamento: 'Peso corporal'),
    // ── Bíceps ─────────────────────────────────────────────────────────────
    const Exercicio(id: 'e20', nome: 'Rosca direta — barra',              grupoMuscular: 'Bíceps',  equipamento: 'Barra'),
    const Exercicio(id: 'e21', nome: 'Rosca alternada',                   grupoMuscular: 'Bíceps',  equipamento: 'Halteres'),
    const Exercicio(id: 'e22', nome: 'Rosca martelo — halteres em pé',    grupoMuscular: 'Bíceps',  equipamento: 'Halteres'),
    const Exercicio(id: 'e52', nome: 'Rosca Scott — barra reta',          grupoMuscular: 'Bíceps',  equipamento: 'Barra'),
    const Exercicio(id: 'e53', nome: 'Rosca concentrada',                 grupoMuscular: 'Bíceps',  equipamento: 'Halteres'),
    const Exercicio(id: 'e54', nome: 'Rosca 21',                          grupoMuscular: 'Bíceps',  equipamento: 'Barra'),
    // ── Tríceps ────────────────────────────────────────────────────────────
    const Exercicio(id: 'e23', nome: 'Tríceps testa — barra',             grupoMuscular: 'Tríceps', equipamento: 'Barra'),
    const Exercicio(id: 'e24', nome: 'Tríceps pulley — corda polia alta', grupoMuscular: 'Tríceps', equipamento: 'Polia'),
    const Exercicio(id: 'e25', nome: 'Mergulho no banco',                 grupoMuscular: 'Tríceps', equipamento: 'Peso corporal'),
    const Exercicio(id: 'e55', nome: 'Tríceps francês — corda sentado',   grupoMuscular: 'Tríceps', equipamento: 'Polia'),
    const Exercicio(id: 'e56', nome: 'Tríceps coice — halter',            grupoMuscular: 'Tríceps', equipamento: 'Halteres'),
    // ── Core ───────────────────────────────────────────────────────────────
    const Exercicio(id: 'e26', nome: 'Prancha isométrica',                grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    const Exercicio(id: 'e27', nome: 'Abdominal remador',                 grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    const Exercicio(id: 'e28', nome: 'Elevação de pernas',                grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    const Exercicio(id: 'e57', nome: 'Abdominal tocando os pés',          grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    const Exercicio(id: 'e58', nome: 'Abdominal infra',                   grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    const Exercicio(id: 'e59', nome: 'Prancha lateral',                   grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    const Exercicio(id: 'e60', nome: 'Russian twist',                     grupoMuscular: 'Core',    equipamento: 'Peso corporal'),
    // ── Mobilidade / Aquecimento ───────────────────────────────────────────
    const Exercicio(id: 'e61', nome: 'Mobilidade de ombro — elástico',    grupoMuscular: 'Mobilidade', equipamento: 'Elástico'),
    const Exercicio(id: 'e62', nome: 'Mobilidade de ombro — bastão',      grupoMuscular: 'Mobilidade', equipamento: 'Bastão'),
    const Exercicio(id: 'e63', nome: 'Mobilidade de quadril — frente',    grupoMuscular: 'Mobilidade', equipamento: 'Peso corporal'),
    const Exercicio(id: 'e64', nome: 'Mobilidade de quadril — diagonal',  grupoMuscular: 'Mobilidade', equipamento: 'Peso corporal'),
    const Exercicio(id: 'e65', nome: 'Alongamento dorsal — espaldar',     grupoMuscular: 'Mobilidade', equipamento: 'Espaldar'),
    const Exercicio(id: 'e66', nome: 'Alongamento de peito — espaldar',   grupoMuscular: 'Mobilidade', equipamento: 'Espaldar'),
    const Exercicio(id: 'e67', nome: 'Flexão de quadril',                 grupoMuscular: 'Mobilidade', equipamento: 'Peso corporal'),
    // ── Cardio ─────────────────────────────────────────────────────────────
    ...
    const Exercicio(id: 'e68', nome: 'Caminhada na esteira c/ inclinação',grupoMuscular: 'Cardio',  equipamento: 'Esteira'),
    const Exercicio(id: 'e69', nome: 'Elíptico',                          grupoMuscular: 'Cardio',  equipamento: 'Elíptico'),
    const Exercicio(id: 'e70', nome: 'Pular corda',                       grupoMuscular: 'Cardio',  equipamento: 'Corda'),
  ];
